...
riva_within_sim_liver <- setorder(riva_within %>% dplyr::filter(Tissue=="liver", chemical!="Spontaneous"),"chemical")
riva_within_sim_lung <- setorder(riva_within %>% dplyr::filter(Tissue=="lung", chemical!="Spontaneous"), "chemical")
