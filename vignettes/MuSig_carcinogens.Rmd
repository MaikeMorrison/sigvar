...
This dataset was assembled from the supplementary data from Riva et al. 2020. It contains COSMIC mice single base substitution mutational signatures (mSBS) along with the organ where the tumor originated and the chemical substances to which the mouse was exposed, with "spontaneous" being the control tumors arising spontaneously in the absence of any exposure.
