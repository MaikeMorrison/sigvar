...
A <- c(7,3,4,1,2,4,3,3,6,6,3,1,4,9,3,6,3,0,1,0,0,2,2,3,1,1,5,0,2,4,1,1,6,4,1,0,4,4,7,3,5,5,5,
       0,5,5,1,4,1,1,4,0,1,1,4,1,1,0,1,1,0,0,3,0,2,1,5,0,2,3,0,0,3,0,1,1,1,1,2,0,0,0,2,0,2,0,0,2,0,0,2,1,0,0,1,1)
...
test_that("get_SBS96_driver_spectrum works", {
  expect_no_warning(get_SBS96_driver_spectrum(TP53_drivers_intogen_LUAD,ref_genome))
  expect_true(all(get_SBS96_driver_spectrum(TP53_drivers_intogen_LUAD,ref_genome)==A) )
  expect_error(get_SBS96_driver_spectrum(A_error))
  expect_false( all(get_SBS96_driver_spectrum(TP53_drivers_intogen_LUAD,ref_genome)==A_error) )
})