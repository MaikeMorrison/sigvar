...
A tutorial on the usage of *sigvar* with a focus on the analysis of compositional data representing microbiome samples is available in the `tutorial` vignette, which is available at [this link](https://maikemorrison.com/files/sigvar_tutorial.html) or via the following code after package installation:
