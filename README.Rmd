...
A tutorial on the usage of *sigvar* is available in the `tutorial` vignette, which is available via the following R code after package installation:
...
Vignettes reproducing figures and analyses from Morrison et al. are available at [github.com/IARCbioinfo/MS_sigvar](https://github.com/IARCbioinfo/MS_sigvar). 
