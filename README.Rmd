...
The package will ultimately be available on Bioconductor. When it is, you will be able to install it with:
...
A tutorial on the usage of *sigvar* is available in the `tutorial` vignette, which is available at [this link](https://maikemorrison.com/files/sigvar_tutorial.html) or via the following R code after package installation:
